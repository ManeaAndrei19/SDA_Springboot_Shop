...
import com.sda.andreimanea.webshop.model.*;
import com.sda.andreimanea.webshop.repository.BillRepository;
import com.sda.andreimanea.webshop.repository.CustomerRepository;
import com.sda.andreimanea.webshop.repository.OrderRepository;
        ...
        if (customer.isPresent()) {
            ...
            for (Long productId : orderDTO.getProductIds()) {
                ...
                if (product.isPresent()) {
                    ...
                    throw new IllegalArgumentException("No product was found in database for the given Id: " + orderDTO.getCustomerId());
                }
            }
            save(customer.get(), products);
        } else {
            throw new IllegalArgumentException("No customer was found in database for the given Id: " + orderDTO.getCustomerId());
        }
    }
